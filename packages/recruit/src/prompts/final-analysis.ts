...
Toute citation ("quote") dans ta réponse doit être copiée MOT POUR MOT depuis une ligne du transcript horodaté ci-dessus, et le "t" associé doit être EXACTEMENT le timestamp affiché entre crochets en face de cette ligne. N'invente jamais une citation, ne la reformule jamais, ne mélange jamais des bouts de deux lignes différentes. La casse de la citation doit être IDENTIQUE, lettre pour lettre, à celle du texte source à cet endroit précis — ni ajout ni retrait de majuscule, dans un sens comme dans l'autre, même si la citation commence au milieu de la phrase source. Si tu ne trouves aucune ligne du candidat qui appuie un point, n'ajoute pas de citation pour ce point plutôt que d'en inventer une.
